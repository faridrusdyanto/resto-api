...
-- Dumping data for table db_resto.access_token: ~9 rows (approximately)
...
-- Dumping data for table db_resto.product: ~3 rows (approximately)
DELETE FROM `product`;
...
INSERT INTO `user` (`id`, `username`, `password`, `role`, `created_at`, `modified_at`) VALUES
	...
	(13, 'vivit', '$2b$10$qFLJunVjnKxBYMnP92qGL./CO/EimX8eFMXMlflOdWUo5/VJPHS7W', 'karyawan', '2023-01-15 03:36:42', '2023-01-15 03:36:42'),
	(14, 'vivita', '$2b$10$AU1IUHla9e1Wvd5k56dF4ev1tnhX/rxxcJnbHQwto1JuL7Y695jjK', 'karyawan', '2023-01-15 04:50:48', '2023-01-15 04:50:48'),
	(15, 'viv', '$2b$10$YxnBBn/PqPQ0kOx0rVgNfOQ7d.JYAWeGXgWEHB05K1muBFv9wHBU2', 'karyawan', '2023-01-15 06:13:59', '2023-01-15 06:13:59');
